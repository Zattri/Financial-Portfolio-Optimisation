...
runGA <- function(noRuns = 30, problem = "feature", generations = 5, crossover = 0.8, mutation = 0.1){
  #Specify GA parameter values; using the default values below. 
  if (problem == "feature"){
    maxGenerations <<- generations    #<<- makes it a global variable. So it will be visible to other functions e.g. monitor()
    popSize = 200
